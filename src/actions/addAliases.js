...
alias updateSystem='sudo rm -f /var/lib/pacman/db.lck && sudo pacman -Syu --noconfirm && yay -Syu --aur --noconfirm --devel --timeupdate && cleanUpSystem${isMain ? ' && resetIdeaSettings' : ''}'
